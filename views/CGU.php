...
<section>
    <div class="form">
        <form action="controllerCGU" method="post">
             <h2>Conditions générales d'utilisation du site projetphp2017.alwaysdata.net/</h2>

            <h4>ARTICLE 1 : Objet</h4>
                <h5>
                    Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site http://projetphp2017.alwaysdata.net/ et leur utilisation par « l'Utilisateur ».
                    ...
                    http://projetphp2017.alwaysdata.net/ se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.
                </h5>
            <h4>ARTICLE 2 : Mentions légales</h4>
                <h5>
                    L'édition du site http://projetphp2017.alwaysdata.net/ est assurée par la Société IUT informatique d'aix en provence au capital de lol € dont le siège social est situé à la rue de la paix(merci le monopoly).
                    Les directeurs de la publication sont Julie qui retourne au S2 mais la designeur en chef ... , Gwen le chef, Guilaume le super actif, Sylvain le redoublant.
            ...
            <h4>ARTICLE 4 : accès aux services</h4>
                <h5>
                    ...
                    -Oula beaucoup trop de chose, inscrivez vous pour voir ....
                    […].
                    Le site est accessible gratuitement pour l'instant en tout lieu à tout Utilisateur ayant un accès à Internet. Tous les frais supportés par l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.) sont à sa charge bien évidemment on est pas riche non plus ....
                    Selon le cas :
                    L’Utilisateur non membre n'a pas accès aux services réservés aux membres VIP. Pour cela, il doit s'identifier à l'aide de son identifiant et de son mot de passe qu'il a intérêt a retenir sinon punition.
            ...
            <label>
            <a href="controllerInscription">
                <input type="button2" value="Retour" />
            </a>
            </label>
        </form>
    </div>
